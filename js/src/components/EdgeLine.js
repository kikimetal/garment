    ...
    render(){
        ...
        return (
            <svg className="EdgeLine">
                ...
                <Motion defaultStyle={{length: this.state.ww, opacity: 2}} style={{length: spring(0 + strokeWidth/2 , lengthSpringOption), opacity: opacitySpring}}>
                ...
                <Motion defaultStyle={{length: this.state.wh, opacity: 3}} style={{length: spring(0 + strokeWidth/2 , lengthSpringOption), opacity: opacitySpring}}>
                ...
                <Motion defaultStyle={{length: 0, opacity: 3}} style={{length: spring(this.state.wh - strokeWidth/2 , lengthSpringOption), opacity: opacitySpring}}>
