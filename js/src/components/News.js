        ...
        return (
            <div className="News" id="news">
                ...
                <div className="flex-2">
                    ...
                    <NewsSection updateDate="2018.10.26">
                        <div>
                            2018.10.31<br/>
                            新製品「ベースフレグランス ネイビー」<br/>
                            先行販売開始
                        </div>
                        <div>
                            <b>堅実な装いに秘めるエレガンス</b><br/>
                            クラシカルな佇まいに濃厚な甘さが漂う、フローラルウッディの香り。<br/>
                            <img
                              src="/image/navy.png"
                              alt="ガーメントベースフレグランスネイビーの画像"
                              style={{
                                width: '100%',
                                display: 'inline-block',
                                maxWidth: '280px'}}
                              />
                            <h1>ベースフレグランス　ネイビー</h1>
                            オートドトワレ／ユニセックス<br/>
                            50mL　12,800円（税抜）<br/>
                            <br/>
                            全国販売に先駆けて、イセタン サロン ド パルファン にて先行販売いたします。
                            ぜひ、この機会にお立ち寄りください。
                        </div>
                    </NewsSection>
                    ...
                    <NewsSection updateDate="2018.10.26">
                        ...
                        <div>
                            <h1>本年も「イセタン サロン ド パルファン」に出店いたします。</h1>
                            <br/>
                            期間中は、クリエイター山下 武尊が店頭で皆さまをお迎え致します。<br/>
                            （各日13-19時　※最終日は17時まで）<br/>
                            ぜひ、この機会にお立ち寄りください。<br/>
                            皆さまのお越しを心よりお待ちしております。<br/>
                            <br/>
                            <b>イセタン サロン ド パルファン概要</b><br/>
                            2018年10月31日（水）～11月5日（月）<br/>
                            伊勢丹新宿店本館7階=催事場<br/>
                            ※最終日は18時終了
                        </div>
                    </NewsSection>
